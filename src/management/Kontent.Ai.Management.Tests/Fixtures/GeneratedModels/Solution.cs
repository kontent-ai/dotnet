...
[ContentType("solution", "f750641e-b3aa-5e4a-9e21-c8871904894d")]
public sealed partial record Solution : IElementsModel
{
    [ContentElement("imaging_technology", "35fc766e-4d5d-58f1-a46f-3ea552eb388d")]
    ...
    [ContentElement("product_base__description", "30f6b775-071e-5a5a-9394-8251d2081b0e")]
    public string? ProductBaseDescription { get; init; }
    [ContentElement("product_base__main_image", "333cb56d-09c7-58a9-b759-97a0931ce8e6")]
    public IEnumerable<AssetReference>? ProductBaseMainImage { get; init; }
    [ContentElement("product_base__name", "9647f1cc-3870-5b67-874b-d56fc2abd7ad")]
    public string? ProductBaseName { get; init; }
    [ContentElement("showcase", "42b24153-7274-550d-8fc1-5f5daea12e89")]
    public RichTextValue? Showcase { get; init; }
    [ContentElement("slug", "0e2c3f0c-9958-53e9-91e4-d6344e08e845")]
