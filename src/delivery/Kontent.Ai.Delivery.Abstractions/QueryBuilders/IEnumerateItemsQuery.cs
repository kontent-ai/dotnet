...
public interface IEnumerateItemsQuery<TModel>
{
    ...
    /// <param name="orderingMode">Ordering mode (ascending/descending).</param>
    IEnumerateItemsQuery<TModel> OrderByElement(string elementCodename, OrderingMode orderingMode = OrderingMode.Ascending);
    ...
    /// <param name="orderingMode">Ordering mode (ascending/descending).</param>
    IEnumerateItemsQuery<TModel> OrderBySystem(string propertyName, OrderingMode orderingMode = OrderingMode.Ascending);
