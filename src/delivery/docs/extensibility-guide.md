...
Use the [Kontent.ai Model Generator](https://github.com/kontent-ai/model-generator-net) to generate model classes with the `[ContentTypeCodename]` attribute:
...
For most projects, use the [Kontent.ai Model Generator](https://github.com/kontent-ai/model-generator-net) with source generation rather than creating type providers manually. The model generator automatically includes the `[ContentTypeCodename]` attribute on generated classes:
