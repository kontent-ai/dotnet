...
The generated Management model shape (records, mapping attributes, collection types) is agreed jointly with `src/management`. Change it there and here together, not in one place.
