...
Foreach($r in $runtimes)
{
	...
	{
		dotnet publish .\Kontent.Ai.ModelGenerator\ -c Release --runtime $r --framework $t --self-contained -o (".\artifacts\" + $r + "\" + $t) -p:PublishSingleFile=true -p:PublishTrimmed=true
